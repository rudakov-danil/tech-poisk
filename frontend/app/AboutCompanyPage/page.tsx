...
export default function page() {
  ...
  return (
    <div className="flex items-start max-lg:flex-col gap-[34px] mt-[20px]">
      <NavigationComponent currentPage={"AboutCompanyPage"} />
      <div className="flex flex-col  w-full">
        ...
        <Link
          href="/"
          className="rounded-[43px] max-w-[265px] mt-[20px] text-[17px] text-[#FF5252] font-bold border-[#FF5252] border-solid border-[1px] px-[25px] py-[14px] text-center flex gap-[10px] items-center"
        >
